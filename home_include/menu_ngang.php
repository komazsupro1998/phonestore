	<div class="mainmenu-area">
        <div class="container">
          ...
          <li class="dropdown"> <a href="index.php?content=dangnhap" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Đăng nhập <strong class="caret"></strong></a>
